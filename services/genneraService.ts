 ...
 * O Proxy adiciona automaticamente a base: https://api2.gennera.com.br/api/v1/
 */
...
async function genneraRequest(endpoint: string, method: string = 'GET') {
  // O Proxy já trata a barra inicial, mas garantimos aqui
 ...
 * Endpoint correto v1: /instituicoes/{id}/unidades-letivas/turmas
 */
export const fetchGenneraClasses = async (): Promise<SchoolClass[]> => {
  ...
  // A API Gennera v1 costuma retornar os dados em 'data' ou na raiz
 ...
 * Endpoint correto v1: /instituicoes/{id}/turmas/{idTurma}/alunos
 */
