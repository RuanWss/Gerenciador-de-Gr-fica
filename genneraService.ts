...
const INSTITUTION_ID = '1782'; // Atualizado conforme ID de cliente no Token JWT

// Unified API token - ensured to be a clean single-line string
...
async function genneraRequest(endpoint: string, method: string = 'GET') {
  // Remove barra inicial se existir para evitar caminhos como /gennera-api//endpoint
