...
import { CheckCircle, AlertTriangle, ScanFace } from 'lucide-react';
                    ...
                    {lastLog && (
                        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-xl animate-in fade-in zoom-in duration-200">
                            <div className="text-center">
                                {/* Photo Circle */}
                                <div className={`mx-auto h-48 w-48 rounded-full border-8 p-1 mb-6 shadow-2xl ${statusType === 'success' ? 'border-green-500 shadow-green-900/50' : 'border-red-500 shadow-red-900/50'}`}>
                                    <img 
                                ...
                                <div className={`inline-flex items-center gap-3 px-8 py-4 rounded-xl text-white font-bold text-xl uppercase tracking-widest shadow-lg ${statusType === 'success' ? 'bg-green-600' : 'bg-red-600'}`}>
                                    {statusType === 'success' ? <CheckCircle size={32}/> : <AlertTriangle size={32}/>}
                                    {statusMessage}
                                </div>
                            </div>
                        </div>
